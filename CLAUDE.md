...
- 18, 19, 20 bedroom 2 (rear, sliding door to deck; door to bedroom 1 in the rear-east corner; floor furnace grate by the east wall)
...
The existing plan was reconstructed from the listing photos only, not measured. Treat room sizes as ±2 ft. Layout as drawn: living room front-left; along its east wall from north to south: an inset cased doorway straight into the front-right room (photo 04: the fireplace wall sits about 1.5 ft east of the hall wall and rear partition, and the doorway is in that step), the built-in, the brick fireplace (flush on the far side), and the door to the front porch; enclosed front porch front-right; **kitchen behind the porch (front-right, ≈11×12)**; small central hall; bathroom on the left; **bedroom 1 rear-right (≈12×12) with a door to the rear porch, reached through a door in the rear corner of bedroom 2** (photo 18); bedroom 2 rear-left with a slider to the deck and the floor furnace grate near its east wall; unfinished enclosed rear porch off bedroom 1. Bathroom position and door placements are the least certain parts.
...
1. **Kitchen moves to the rear-left room with the slider** so it opens directly onto the deck (eat-in, ≈13×12). Reason: don't want to walk through a bedroom to reach the yard. The new kitchen shares its south wall with the bathroom, so the wet wall is shared.
2. **Old kitchen (front-right, ≈11×12) becomes bedroom 1.** Its plumbing gets abandoned.
3. **Rear-right bedroom stays a bedroom** and becomes bedroom 2 (≈12×12) with a closet added on the hall wall. It keeps the existing corner door, which now opens from the kitchen; a door from the hall would need the hall's east wall opened. Range goes on the west wall with the sink; the corner door rules out a run on the back wall.
...
5. Living room, bath, hall, front porch unchanged in this pass. Open question: the living room's inset doorway opens straight into the old kitchen, which becomes bedroom 1. Either close it and use the hall door, or accept a bedroom off the living room.
